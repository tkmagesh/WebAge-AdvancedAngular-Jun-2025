  ...
  template: `
    <div class="operator-container">
      ...
      <div class="operator-info">
        <h3>Description</h3>
        <p>The <code>map</code> operator transforms each emitted value by applying a function to it.</p>
        
        <h3>Use Cases</h3>
        <ul>
          <li>Transform data structure</li>
          <li>Extract specific properties from objects</li>
          <li>Convert data types</li>
          <li>Apply mathematical operations</li>
        </ul>
        
        <h3>Syntax</h3>
        <pre><code>source$.pipe(map(value => transformedValue))</code></pre>
      </div>
      ...
      <div class="demo-section">
        ...
        <div class="results">
          <div class="result-column">
            ...
            <div class="values">
              <div *ngFor="let value of originalValues" class="value original">
                {{ value }}
              </div>
            </div>
          </div>
          ...
          <div class="result-column">
            <h4>Mapped Values (x * 2)</h4>
            <div class="values">
              <div *ngFor="let value of mappedValues" class="value mapped">
                {{ value }}
              </div>
            </div>
          </div>
...
// Apply map operator to transform each value
